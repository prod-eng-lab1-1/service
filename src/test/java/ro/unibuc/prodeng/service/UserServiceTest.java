...
class UserServiceTest {
    ...
    void testGetAllUsers_returnsList() {
        when(userRepository.findAll()).thenReturn(List.of(new UserEntity("1", "Luke", "luke@jedi.com", 0, UserRank.BRONZE)));
    ...
    void testGetUserById_existingUser_returnsUser() throws Exception {
        when(userRepository.findById("1")).thenReturn(Optional.of(new UserEntity("1", "Luke", "luke@jedi.com", 0, UserRank.BRONZE)));
    ...
    void testCreateUser_validData_savesUser() {
        ...
        when(userRepository.save(any(UserEntity.class))).thenAnswer(i -> new UserEntity("1", "Luke", "luke@jedi.com", 0, UserRank.BRONZE));
    ...
    void testChangeName_existingUser_updatesName() throws Exception {
        when(userRepository.findById("1")).thenReturn(Optional.of(new UserEntity("1", "Old", "luke@jedi.com", 0, UserRank.BRONZE)));
